...
import fr.ensma.a3.ia.jeupersonnagesv1.elements.comportement.deplacements.EnCourrant;
import fr.ensma.a3.ia.jeupersonnagesv1.elements.groupements.Troupe;
...
public class App {
    ...
    public static void main(String[] args) {
        try {
            ...
            Troupe trWinter = new Troupe(hodor);
            trWinter.rejoindreTroupe(jSnow);
            Troupe trCastral = new Troupe(joffrey);
            Troupe trBizarre = new Troupe(viserion);
            trBizarre.rejoindreTroupe(trCastral);
            trBizarre.rejoindreTroupe(trWinter);
            trBizarre.deplacer();
            
            jSnow.arretDeplacement();
            
            jSnow.setCompoDeplacement(new EnCourrant());
            jSnow.deplacer();
